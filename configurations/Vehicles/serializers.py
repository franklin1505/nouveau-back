...
#         specific_clients_data = validated_data.pop('specific_clients', [])
#         excluded_clients_data = validated_data.pop('excluded_clients', [])

#         # Gérer les relations imbriquées
#         adjustment_data = validated_data.pop('adjustment', None)
...
#         if specific_clients_data:
#             tariff_rule.specific_clients.set(specific_clients_data)
#         if excluded_clients_data:
#             tariff_rule.excluded_clients.set(excluded_clients_data)

#         # Ajouter les relations imbriquées
#         if adjustment_data:
#             adjustment = Adjustment.objects.create(**adjustment_data)
#             tariff_rule.adjustment = adjustment
#         if package_data:
#             package = Package.objects.create(**package_data)
#             tariff_rule.package = package
#         if promo_code_data:
#             promo_code = PromoCode.objects.create(**promo_code_data)
#             tariff_rule.promo_code = promo_code
...
#     def update(self, instance, validated_data):
#         # Extraire les données ManyToMany
#         specific_clients_data = validated_data.pop('specific_clients', None)
#         excluded_clients_data = validated_data.pop('excluded_clients', None)

#         # Mettre à jour les relations imbriquées
#         if 'adjustment' in validated_data:
#             adjustment_data = validated_data.pop('adjustment', None)
#             if adjustment_data:
#                 Adjustment.objects.update_or_create(
#                     pk=instance.adjustment.pk if instance.adjustment else None,
#                     defaults=adjustment_data
#                 )
...
#                     pk=instance.package.pk if instance.package else None,
...
#                     pk=instance.promo_code.pk if instance.promo_code else None,
#                     defaults=promo_code_data
#                 )

#         # Mettre à jour les relations ManyToMany
#         if specific_clients_data is not None:
#             instance.specific_clients.set(specific_clients_data)
#         if excluded_clients_data is not None:
#             instance.excluded_clients.set(excluded_clients_data)
